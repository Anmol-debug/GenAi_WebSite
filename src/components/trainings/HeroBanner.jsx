      ...
      <div className="relative shadow overflow-hidden w-full h-[300px] sm:h-[360px] md:h-[420px] lg:h-[480px] xl:h-[400px] 2xl:h-[580px] flex">
        ...
        <div className="absolute left-0 -top-6 right-0 bottom-0 flex flex-col justify-center items-center px-4 text-center text-white max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mt-2">
            ...
            <p className="cursor-pointer hover:bg-[white] hover:text-[#4e8ad9] font-medium tracking-wide border-2 border-[#4e8ad9] transition px-6 py-3 text-white rounded-lg shadow text-xs sm:text-sm whitespace-nowrap">
              View Curriculum
            </p>
          </div>
          <div className="flex justify-center items-center gap-4 mt-4 text-xs sm:text-sm text-white">
